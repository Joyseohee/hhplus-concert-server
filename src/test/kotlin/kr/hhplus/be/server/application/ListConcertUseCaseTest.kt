...
class ListConcertUseCaseTest(
    ...
    companion object {
        ...
        private const val DAYS_INTERVAL   = 10L
        private const val SECONDS_PER_DAY = 24 * 3600L
        private const val VENUE           = "서울 올림픽공원 체조경기장"
        private const val TITLE_PREFIX    = "HH+ Concert"
    }
